...
public class MerchantRegisrationIdData {
	...
	public String toString() {
		return "MerchantRegisrationIdData [id=" + id + ", merchantName="
				+ merchantName + ", merchantPhoneNumber=" + merchantPhoneNumber
				+ ", emailId=" + emailId + ", domainNameValidation="
				+ domainNameValidation + ", merchantRegisrationRefNumber="
				+ merchantRegisrationRefNumber + ", aadharValidation="
				+ aadharValidation + ", panValidationStatus="
				+ panValidationStatus + ", registrationType="
				+ registrationType + ", remarks=" + remarks
				+ ", securityCheck=" + securityCheck + ", status=" + status
				+ ", tanValidationStatus=" + tanValidationStatus
				+ ", timestamp=" + timestamp + ", updatedTimestamp="
				+ updatedTimestamp + ", keywordsVerification="
				+ keywordsVerification + ", highandlowriskbusinesscheck="
				+ highandlowriskbusinesscheck
				+ ", currentaccountbalancetransferverification="
				+ currentaccountbalancetransferverification
				+ ", websiteVerifications=" + websiteVerifications
