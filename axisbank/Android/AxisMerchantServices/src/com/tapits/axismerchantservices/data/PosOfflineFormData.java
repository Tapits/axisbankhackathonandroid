...
public class PosOfflineFormData {
	...
	public String toString() {
		return "PosOfflineFormData [id=" + id + ", format=" + format
				+ ", frequency=" + frequency + ", remarks=" + remarks
				+ ", statement=" + statement + ", timestamp=" + timestamp
				+ ", typeOfMaterial=" + typeOfMaterial + ", typeOfPos="
				+ typeOfPos + ", vas=" + vas + ", merchantRegisrationId="
