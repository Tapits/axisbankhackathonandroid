...
public class SettlementFormData {
	...
	public String toString() {
		return "SettlementFormData [id=" + id + ", currentAccountNumber="
				+ currentAccountNumber + ", mode=" + mode + ", remarks="
				+ remarks + ", timesatmp=" + timesatmp + ", validationFlag="
				+ validationFlag + ", merchantRegisrationId="
				+ merchantRegisrationId + "]";
	}
