...
public class GetMerchantRegisrationRefNumberData {
	...
	public String toString() {
		return "GetMerchantRegisrationRefNumberData [regType=" + regType
				+ ", debitCardFlag=" + debitCardFlag + ", creaditCardFlag="
				+ creaditCardFlag + ", netBakingFlag=" + netBakingFlag
				+ ", mobileAppilication=" + mobileAppilication + "]";
	}
