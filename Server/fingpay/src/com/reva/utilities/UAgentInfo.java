...
//**************************************************************************
	...
	public UAgentInfo(String userAgent, String httpAccept,
			boolean initCompleted, boolean isWebkit, boolean isMobilePhone,
			boolean isIphone, boolean isAndroid, boolean isAndroidPhone,
			boolean isTierTablet, boolean isTierIphone, boolean isTierRichCss,
		...
		this.isTierTablet = isTierTablet;
		this.isTierIphone = isTierIphone;
		this.isTierRichCss = isTierRichCss;
		this.isTierGenericMobile = isTierGenericMobile;
	}
	...
	public void setMobilePhone(boolean isMobilePhone) {
		this.isMobilePhone = isMobilePhone;
	}
	...
	public void setAndroidPhone(boolean isAndroidPhone) {
		this.isAndroidPhone = isAndroidPhone;
	}

	public static String getEnginewebkit() {
		return engineWebKit;
	}

	public static String getDeviceiphone() {
		return deviceIphone;
	}

	public static String getDeviceipod() {
		return deviceIpod;
	}

	public static String getDeviceipad() {
		return deviceIpad;
	}

	public static String getDevicemacppc() {
		return deviceMacPpc;
	}

	public static String getDeviceandroid() {
		return deviceAndroid;
	}

	public static String getDevicegoogletv() {
		return deviceGoogleTV;
	}

	public static String getDevicehtcflyer() {
		return deviceHtcFlyer;
	}

	public static String getDevicewinphone7() {
		return deviceWinPhone7;
	}

	public static String getDevicewinphone8() {
		return deviceWinPhone8;
	}

	public static String getDevicewinmob() {
		return deviceWinMob;
	}

	public static String getDevicewindows() {
		return deviceWindows;
	}

	public static String getDeviceiemob() {
		return deviceIeMob;
	}

	public static String getDeviceppc() {
		return devicePpc;
	}

	public static String getEnginepie() {
		return enginePie;
	}

	public static String getDevicebb() {
		return deviceBB;
	}

	public static String getDevicebb10() {
		return deviceBB10;
	}

	public static String getVndrim() {
		return vndRIM;
	}

	public static String getDevicebbstorm() {
		return deviceBBStorm;
	}

	public static String getDevicebbbold() {
		return deviceBBBold;
	}

	public static String getDevicebbboldtouch() {
		return deviceBBBoldTouch;
	}

	public static String getDevicebbtour() {
		return deviceBBTour;
	}

	public static String getDevicebbcurve() {
		return deviceBBCurve;
	}

	public static String getDevicebbcurvetouch() {
		return deviceBBCurveTouch;
	}

	public static String getDevicebbtorch() {
		return deviceBBTorch;
	}

	public static String getDevicebbplaybook() {
		return deviceBBPlaybook;
	}

	public static String getDevicesymbian() {
		return deviceSymbian;
	}

	public static String getDevices60() {
		return deviceS60;
	}

	public static String getDevices70() {
		return deviceS70;
	}

	public static String getDevices80() {
		return deviceS80;
	}

	public static String getDevices90() {
		return deviceS90;
	}

	public static String getDevicepalm() {
		return devicePalm;
	}

	public static String getDevicewebos() {
		return deviceWebOS;
	}

	public static String getDeviceweboshp() {
		return deviceWebOShp;
	}

	public static String getEngineblazer() {
		return engineBlazer;
	}

	public static String getEnginexiino() {
		return engineXiino;
	}

	public static String getDevicenuvifone() {
		return deviceNuvifone;
	}

	public static String getDevicebada() {
		return deviceBada;
	}

	public static String getDevicetizen() {
		return deviceTizen;
	}

	public static String getDevicemeego() {
		return deviceMeego;
	}

	public static String getDevicekindle() {
		return deviceKindle;
	}

	public static String getEnginesilk() {
		return engineSilk;
	}

	public static String getVndwap() {
		return vndwap;
	}

	public static String getWml() {
		return wml;
	}

	public static String getDevicetablet() {
		return deviceTablet;
	}

	public static String getDevicebrew() {
		return deviceBrew;
	}

	public static String getDevicedanger() {
		return deviceDanger;
	}

	public static String getDevicehiptop() {
		return deviceHiptop;
	}

	public static String getDeviceplaystation() {
		return devicePlaystation;
	}

	public static String getDeviceplaystationvita() {
		return devicePlaystationVita;
	}

	public static String getDevicenintendods() {
		return deviceNintendoDs;
	}

	public static String getDevicenintendo() {
		return deviceNintendo;
	}

	public static String getDevicewii() {
		return deviceWii;
	}

	public static String getDevicexbox() {
		return deviceXbox;
	}

	public static String getDevicearchos() {
		return deviceArchos;
	}

	public static String getEngineopera() {
		return engineOpera;
	}

	public static String getEnginenetfront() {
		return engineNetfront;
	}

	public static String getEngineupbrowser() {
		return engineUpBrowser;
	}

	public static String getEngineopenweb() {
		return engineOpenWeb;
	}

	public static String getDevicemidp() {
		return deviceMidp;
	}
	...
	public static String getEnginetelecaq() {
		return engineTelecaQ;
	}

	public static String getEngineobigo() {
		return engineObigo;
	}

	public static String getDevicepda() {
		return devicePda;
	}
	...
	public static String getQtembedded() {
		return qtembedded;
	}

	public static String getMylocom2() {
		return mylocom2;
	}

	public static String getManusonyericsson() {
		return manuSonyEricsson;
	}

	public static String getManuericsson() {
		return manuericsson;
	}

	public static String getManusamsung1() {
		return manuSamsung1;
	}

	public static String getManusony() {
		return manuSony;
	}

	public static String getManuhtc() {
		return manuHtc;
	}

	public static String getSvcdocomo() {
		return svcDocomo;
	}

	public static String getSvckddi() {
		return svcKddi;
	}

	public static String getSvcvodafone() {
		return svcVodafone;
	}

	public static String getDisupdate() {
		return disUpdate;
	}
	...
	public void setTierTablet(boolean isTierTablet) {
		this.isTierTablet = isTierTablet;
	}

	public void setTierIphone(boolean isTierIphone) {
		this.isTierIphone = isTierIphone;
	}

	public void setTierRichCss(boolean isTierRichCss) {
		this.isTierRichCss = isTierRichCss;
	}

	public void setTierGenericMobile(boolean isTierGenericMobile) {
		this.isTierGenericMobile = isTierGenericMobile;
	}

	@Override
	public String toString() {
		return "UAgentInfo [userAgent=" + userAgent + ", httpAccept="
				+ httpAccept + ", initCompleted=" + initCompleted
				+ ", isWebkit=" + isWebkit + ", isMobilePhone=" + isMobilePhone
				+ ", isIphone=" + isIphone + ", isAndroid=" + isAndroid
				+ ", isAndroidPhone=" + isAndroidPhone + ", isTierTablet="
				+ isTierTablet + ", isTierIphone=" + isTierIphone
				+ ", isTierRichCss=" + isTierRichCss + ", isTierGenericMobile="
				+ isTierGenericMobile + "]";
	}
